...
import { faCalendarWeek, faTasks, faArrowAltCircleDown } from "@fortawesome/free-solid-svg-icons";
const Sidebar = () => {
  return (
    <div className=" h-screen bg-slate-100 pt-4 pl-4 text-left w-[200px]">
      ...
      <div className=" pb-8">
        ...
        <p className=" pb-2 text-[18px] hover:text-blue-600 cursor-pointer">Personal</p>
        <p className=" pb-2 text-[18px] hover:text-blue-600 cursor-pointer">Work</p>
        <p className=" pb-2 text-[18px] hover:text-blue-600 cursor-pointer">Groceries</p>
        <p className=" pb-2 text-[18px] hover:text-blue-600 cursor-pointer">Shopping</p>
      </div>
